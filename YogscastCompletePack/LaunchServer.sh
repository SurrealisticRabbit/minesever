...
echo "Launching forge-1.6.4-9.11.1.965-universal.jar with '$MEMORY' max memory, jvm args '$JVMARGS' and arguments '$LAUNCHARGS'"

$JAVAPATH -Xmx$MEMORY $JVMARGS   -jar forge-1.6.4-9.11.1.965-universal.jar "$LAUNCHARGS"
