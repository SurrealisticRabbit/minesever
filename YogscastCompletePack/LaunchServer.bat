...
echo Launching forge-1.6.4-9.11.1.965-universal.jar with '%mem%' max memory, jvm args '%jvmargs%' and arguments '%launchargs%'

:: add nogui to the end of this line to disable the gui ::
"%javapath%" -Xmx%mem% %jvm_args%   -jar forge-1.6.4-9.11.1.965-universal.jar %launchargs%
PAUSE
